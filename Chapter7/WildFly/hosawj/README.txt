...
a persistence unit "hosawjPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "hosawj\pom.xml":
...
artifact ("hosawj.war") is already built. You can build
